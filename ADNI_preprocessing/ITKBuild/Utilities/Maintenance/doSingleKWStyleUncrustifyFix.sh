...
${UNCRUSTIFYBIN} -c /Users/a---/Desktop/InsightToolkit-5.0.1/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} | sed 's/  *##  */##/g' | sed 's/#  */#/g' > ${file}_uncrustify
...
KWSTYLE_EXECUTABLE-NOTFOUND -xml /Users/a---/Desktop/Visual-Feature-Attribution-Using-Wasserstein-GANs-Pytorch/ADNI_preprocessing/ITKBuild/Utilities/KWStyle/ITK.kws.xml -v -o /Users/a---/Desktop/InsightToolkit-5.0.1/Utilities/KWStyle/ITKOverwrite.txt -gcc $file > ${KWERRORS}
...
if [ -f ${KWERRORS} ]; then
  ...
  if [ ${skipuncrustify} == "y" ]; then
    ${UNCRUSTIFYBIN} -c /Users/a---/Desktop/InsightToolkit-5.0.1/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} -o ${KWERRORS}_skip_uncrustify
  fi
